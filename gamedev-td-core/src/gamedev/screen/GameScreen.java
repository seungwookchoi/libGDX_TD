...
//modify(2017.02.09 12:39 By JangMinWoo)
...
public class GameScreen extends GDScreen {
	...
	//add SkipButton  at userInterface
	public TowerRangeRenderer getTowerRangeRender(){
		GameUserInterface userinterface = null;
		return userinterface.towerRangeRenderer;
	}
